    ...
    <div id="app">
        ...
        <div v-else>
            <button @click="registering=false"
                    :class="registering ?'button-outline' : ''">Loguje się
            </button>

            <button @click="registering=true"
                    :class="!registering ?'button-outline' : ''">Rejestruje się
            </button>

            <div v-if="error" class="error-allert">{{ error }}</div>
            ...
            methods: {
                ...
                register(user) {
                    ...
                    this.$http.post('participants', user)
                        ...
                        .catch(response => {
                            this.error = "Nazwa uzytkownika jest zajęta"
                        });
                },
